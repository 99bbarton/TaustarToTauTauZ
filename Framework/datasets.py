...
crossections_run3 = {
        ...
        "TTto2L2Nu" : [923.6*0.105, 923.6*0.05],#[762.1, 0.1345],
        "TTto4Q" : [923.6*0.457, 923.6*0.05],#[762.1, 0.1345],
        "TTtoLNu2Q" : [923.6*0.438, 923.6*0.05],#[762.1, 0.1345],
        "TBbarQ_t-channel_4FS" : [145, 2.8],#[123.8, 0.3709], #https://twiki.cern.ch/twiki/bin/view/LHCPhysics/SingleTopNNLORef
        "TWminusto4Q": [0.457*0.5*87.9, 3.1],#[35.99, 0.01292],
        "TWminusto2L2Nu" : [0.105*0.5*87.9, 3.1],#[35.99, 0.01292],
        "TWminustoLNu2Q" : [0.438*0.5*87.9, 3.1],#[35.99, 0.01292],
        "TbarBQ_t-channel_4FS" : [87.2, 1.8],#[75.47, 0.2361],
        "TbarWplusto2L2Nu" : [0.105*0.5*87.9, 3.1],#[36.05, 0.01296],
        "TbarWplusto4Q" : [0.475*0.5*87.9, 3.1],#[36.05, 0.01296],
        "TbarWplustoLNu2Q" : [0.438*0.5*87.9, 3.1],#[36.05, 0.01296],
