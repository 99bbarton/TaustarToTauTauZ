...
stageToCMSSW = {"2015" : ["","CMSSW_10_6_30_patch1", "CMSSW_10_6_17_patch1","CMSSW_10_6_17_patch1", "CMSSW_8_0_36_UL_patch1", "CMSSW_10_6_17_patch1","CMSSW_10_6_25", "CMSSW_10_6_26"], "2016" : ["","CMSSW_10_6_30_patch1", "CMSSW_10_6_17_patch1","CMSSW_10_6_17_patch1", "CMSSW_8_0_36_UL_patch1", "CMSSW_10_6_17_patch1","CMSSW_10_6_25", "CMSSW_10_6_26"], "2017" : ["","CMSSW_10_6_30_patch1","CMSSW_10_6_17_patch1","CMSSW_10_6_17_patch1","CMSSW_9_4_14_UL_patch1","CMSSW_10_6_17_patch1","CMSSW_10_6_20","CMSSW_10_6_26"],"2018" : ["","CMSSW_10_6_30_patch1","CMSSW_10_6_17_patch1","CMSSW_10_6_17_patch1","CMSSW_10_2_16_UL","CMSSW_10_6_17_patch1","CMSSW_10_6_20","CMSSW_10_6_26"]}
...
def buildCommand(args, jobN):
    ...
    if args.stage == 1:
        ...
        if args.year == "2015":
            command = "cmsDriver.py --python_filename taustarToTau"+decay+"_m"+args.mass+"_s2_"+str(jobN)+".py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:taustarToTau"+decay+"_m"+args.mass+"_s2_"+str(jobN)+".root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --step SIM --geometry DB:Extended --filein file:taustarToTau"+decay+"_m"+args.mass+"_s1_"+str(jobN)+".root --era Run2_2016_HIPM --runUnscheduled --no_exec --mc -n " + str(args.nEvents)
        elif args.year == "2016":
            command = "cmsDriver.py --python_filename taustarToTau"+decay+"_m"+args.mass+"_s2_"+str(jobN)+".py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:taustarToTau"+decay+"_m"+args.mass+"_s2_"+str(jobN)+".root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step SIM --geometry DB:Extended --filein file:taustarToTau"+decay+"_m"+args.mass+"_s1_"+str(jobN)+".root --era Run2_2016 --runUnscheduled --no_exec --mc -n " + str(args.nEvents)
        elif args.year == "2017":
        ...
        if args.year == "2015":
            command = 'cmsDriver.py --python_filename taustarToTau'+decay+'_m'+args.mass+'_s4_'+str(jobN)+'.py --eventcontent RAWSIM --outputCommand "keep *_mix_*_*,keep *_genPUProtons_*_*" --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --inputCommands "keep *","drop *_*_BMTF_*","drop *PixelFEDChannel*_*_*_*" --fileout file:taustarToTau'+decay+'_m'+args.mass+'_s4_'+str(jobN)+'.root --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --customise_commands "process.source.bypassVersionCheck = cms.untracked.bool(True)" --step HLT:25ns15e33_v4 --geometry DB:Extended --filein file:taustarToTau'+decay+'_m'+args.mass+'_s3_'+str(jobN)+'.root --era Run2_2016 --no_exec --mc -n ' + str(args.nEvents)
        elif args.year == "2016":
            command = 'cmsDriver.py --python_filename taustarToTau'+decay+'_m'+args.mass+'_s4_'+str(jobN)+'.py --eventcontent RAWSIM --outputCommand "keep *_mix_*_*,keep *_genPUProtons_*_*" --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --inputCommands "keep *","drop *_*_BMTF_*","drop *PixelFEDChannel*_*_*_*" --fileout file:taustarToTau'+decay+'_m'+args.mass+'_s4_'+str(jobN)+'.root --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --customise_commands "process.source.bypassVersionCheck = cms.untracked.bool(True)" --step HLT:25ns15e33_v4 --geometry DB:Extended --filein file:taustarToTau'+decay+'_m'+args.mass+'_s3_'+str(jobN)+'.root --era Run2_2016 --no_exec --mc -n ' + str(args.nEvents)
        elif args.year == "2017":
        ...
        if args.year == "2015":
            command = "cmsDriver.py --python_filename taustarToTau"+decay+"_m"+args.mass+"_s5_"+str(jobN)+".py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:taustarToTau"+decay+"_m"+args.mass+"_s5_"+str(jobN)+".root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --geometry DB:Extended --filein file:taustarToTau"+decay+"_m"+args.mass+"_s4_"+str(jobN)+".root --era Run2_2016_HIPM --runUnscheduled --no_exec --mc -n " + str(args.nEvents)
        elif args.year == "2016":
            command = "cmsDriver.py --python_filename taustarToTau"+decay+"_m"+args.mass+"_s5_"+str(jobN)+".py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:taustarToTau"+decay+"_m"+args.mass+"_s5_"+str(jobN)+".root --conditions 106X_mcRun2_asymptotic_v13 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --geometry DB:Extended --filein file:taustarToTau"+decay+"_m"+args.mass+"_s4_"+str(jobN)+".root --era Run2_2016 --runUnscheduled --no_exec --mc -n " + str(args.nEvents)
        elif args.year == "2017":
        ...
        if args.year == "2015":
            command = "cmsDriver.py --python_filename taustarToTau"+decay+"_m"+args.mass+"_s6_"+str(jobN)+".py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:taustarToTau"+decay+"_m"+args.mass+"_s6_"+str(jobN)+".root --conditions 106X_mcRun2_asymptotic_preVFP_v11 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein file:taustarToTau"+decay+"_m"+args.mass+"_s5_"+str(jobN)+".root --era Run2_2016_HIPM --runUnscheduled --no_exec --mc -n " + str(args.nEvents)
        elif args.year == "2016":
            command = "cmsDriver.py --python_filename taustarToTau"+decay+"_m"+args.mass+"_s6_"+str(jobN)+".py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:taustarToTau"+decay+"_m"+args.mass+"_s6_"+str(jobN)+".root --conditions 106X_mcRun2_asymptotic_v17 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein file:taustarToTau"+decay+"_m"+args.mass+"_s5_"+str(jobN)+".root --era Run2_2016 --runUnscheduled --no_exec --mc -n " + str(args.nEvents)
        elif args.year == "2017":
        ...
        if args.year == "2015":
            command = "cmsDriver.py --python_filename taustarToTau"+decay+"_m"+args.mass+"_s7_"+str(jobN)+".py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:taustarToTau"+decay+"_m"+args.mass+"_s7_"+str(jobN)+".root --conditions 106X_mcRun2_asymptotic_preVFP_v11 --step NANO --filein file:taustarToTau"+decay+"_m"+args.mass+"_s6_"+str(jobN)+".root --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --no_exec --mc -n " + str(args.nEvents)
        elif args.year == "2016":
            command = "cmsDriver.py --python_filename taustarToTau"+decay+"_m"+args.mass+"_s7_"+str(jobN)+".py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:taustarToTau"+decay+"_m"+args.mass+"_s7_"+str(jobN)+".root --conditions 106X_mcRun2_asymptotic_v17 --step NANO --filein file:taustarToTau"+decay+"_m"+args.mass+"_s6_"+str(jobN)+".root --era Run2_2016,run2_nanoAOD_106Xv2 --no_exec --mc -n " + str(args.nEvents)
        elif args.year == "2017":
