#Slightly modified from the version here: https://github.com/cms-sw/cmssw/blob/736532d9975f1d364bb698562d0a670a9a2fa58b/PhysicsTools/NanoAOD/python/custom_btv_cff.py
#Modified to only add PF info
...
def PrepBTVCustomNanoAOD_MC(process):    
    ...
    #add_BTV(process, True,nanoAOD_addbtagAK4_switch,nanoAOD_addbtagAK8_switch) ##################################################### BBARTON
    return process
def PrepBTVCustomNanoAOD_DATA(process):
    ...
    #add_BTV(process, False,nanoAOD_addbtagAK4_switch,nanoAOD_addbtagAK8_switch) ###################################################### BBARTON
    return process
