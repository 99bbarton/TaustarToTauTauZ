#Modified version of the auto generated config file from https://github.com/cms-btv-pog/btvnano-prod/tree/NanoAODv12_22Sep2023
#Modifed to work for Condor processing and to correspond to 2024
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(os.environ["INP_FILE"]),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('addPFNano_2024 nevts:-1'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:' + str(os.environ["OUT_FILE"])),
...
#BBARTON globaltag picked from https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-RunIII2024Summer24NanoAODv15-00452
