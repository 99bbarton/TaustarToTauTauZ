...
{   
    ...
    //Get the PDFs
    PDF* nomPDF = LHAPDF::mkPDF(nomPDF); 
    PDF* varPDFs[nVars];
    for (int i = 0; i< nVars; i++)
    {
        varPDFs[i] = LHAPDF::mkPDF(nomPDF + 1 + i);
    }
    
    //Add the weights to each file
    cout << "\nBeginning " << year << "..." << endl;
    TString masses[N_FILES] = {"m250","m500","m750","m1000","m1250","m1500","m1750","m2000","m2500","m3000","m3500","m4000","m4500","m5000"};
    ...
    for (int fN = 0; fN < N_FILES; fN++)
    {
        ...
        TString filename = "../Data/SignalMC/WithPDFWeights/"+year+"/V2/taustarToTauZ_"+masses[fN]+"_"+year+".root";
